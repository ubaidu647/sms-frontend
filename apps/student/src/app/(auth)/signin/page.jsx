...
const SignInPage = () => {
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#15244a] via-[#13203f] to-[#0c1730] text-white p-12 flex-col justify-between">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-10 w-fit">
            <div className="w-10 h-10 rounded-xl bg-[#15244a] flex items-center justify-center shadow-lg shadow-[#15244a]/30">
              <GraduationCap className="w-5 h-5 text-[#f5b21c]" />
            </div>
