    ...
    <div className="space-y-4">
      ...
      {(!classId || !sectionId) && (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          <p className="text-gray-500">Pick a class, section and month to load the summary.</p>
        </div>
      )}
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-center px-3 py-3 text-xs font-semibold text-orange-700 uppercase tracking-wide">Half</th>
                <th className="text-center px-3 py-3 text-xs font-semibold text-red-700 uppercase tracking-wide">Absent</th>
                <th className="text-center px-3 py-3 text-xs font-semibold text-blue-700 uppercase tracking-wide">Leave</th>
                <th className="text-center px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Holiday</th>
                <th className="text-center px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Total</th>
                <th className="text-center px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Attendance %</th>
              </tr>
            </thead>
            <tbody>
              {students.map((s) => (
                <tr key={s.studentId} className="border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
                  ...
                  <td className="px-3 py-3 text-center text-sm font-medium text-gray-900">{s.total}</td>
