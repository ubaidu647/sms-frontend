  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-4 mb-4 no-print">
          <label className="block text-xs font-semibold text-gray-600 mb-1">Section</label>
          <select
            value={sectionId}
            onChange={(e) => setSectionId(e.target.value)}
            className="w-full md:w-80 px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white text-gray-900 outline-none focus:border-teal-500"
          >
        ...
        {!sectionId ? (
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center text-gray-500 text-sm no-print">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 print-area" id="printable">
            <SchoolHeader
              user={user}
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-100 text-xs uppercase text-gray-700">
                  ...
                  <th className="border border-gray-300 px-2 py-2 text-left">Roll</th>
                  <th className="border border-gray-300 px-2 py-2 text-left">Adm No.</th>
                  ...
                  <th className="border border-gray-300 px-2 py-2 text-center">Failed</th>
              ...
              <tbody>
                {studentsRanked.map((s) => (
                  <tr
                    key={s.studentId}
                    className={!s.isPassed ? 'bg-red-50' : 'hover:bg-gray-50'}
                  >
                    <td className="border border-gray-300 px-2 py-2 font-bold">
                      {s.position}
                    </td>
                    <td className="border border-gray-300 px-2 py-2">{s.rollNumber || '—'}</td>
