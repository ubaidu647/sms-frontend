      ...
      {isLoading || !p ? (
        ...
        <div className="space-y-5">
          <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest">Receipt</div>
            <div className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{p.receiptNumber}</div>
            <div
            ...
            {p.isVoid && (
              <div className="mt-2 inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700 dark:text-red-400">
                Voided
              </div>
            )}
          </div>
          ...
          {p.notes && (
            <div>
              <div className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Notes</div>
              <div className="text-sm text-gray-800 dark:text-gray-200">{p.notes}</div>
            </div>
          )}
