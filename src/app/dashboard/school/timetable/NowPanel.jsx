        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {data?.period ? (
              ...
              <p className="text-sm text-gray-500">No active period</p>
            )}
          </div>
        </div>
        {isOrgLevel && (
      ...
      {data?.slots?.length ? (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
            ...
            <p className="text-xs text-gray-500">Auto-refreshes every minute</p>
          </div>
          <div className="divide-y divide-gray-100">
            {data.slots.map((s) => (
              <div
                key={s._id}
                className="px-4 py-3 flex items-center justify-between flex-wrap gap-2 hover:bg-gray-50"
              >
                <div>
