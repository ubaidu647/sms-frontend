...
const MENU = [
  ...
  { label: 'Roles', icon: 'shield', path: '/(app)/roles' },
  { label: 'Classes', icon: 'layers', path: '/(app)/classes' },
  { label: 'Subjects', icon: 'book-open', path: '/(app)/subjects' },
  { label: 'Students', icon: 'user', path: '/(app)/students' },
  { label: 'Attendance', icon: 'check-square', path: '/(app)/attendance' },
  { label: 'Staff Attendance', icon: 'user-check', path: '/(app)/staff-attendance' },
  { label: 'Staff Salary', icon: 'dollar-sign', path: '/(app)/staff-salary' },
  { label: 'Teacher Assignments', icon: 'book', path: '/(app)/teacher-assignments' },
  { label: 'Exams', icon: 'file-text', path: '/(app)/exams' },
  { label: 'Timetable', icon: 'calendar', path: '/(app)/timetable' },
  { label: 'Fees', icon: 'credit-card', path: '/(app)/fees' },
  { label: 'Announcements', icon: 'volume-2', path: '/(app)/announcements' },
  { label: 'Transport', icon: 'truck', path: '/(app)/transport' },
  { label: 'Branch Profile', icon: 'briefcase', path: '/(app)/branches/my-profile' },
  { label: 'Reports', icon: 'bar-chart-2', path: '/(app)/reports' },
];
